  ...
  return [
    {
      ...
      preferredStructure: closed ? "Contract pending verification" : "SPY 07/27 $635 Call",
      t1: closed ? null : 1.66,
      stop: closed ? null : 0.89,
      confidence: 88,
      reason: "SPY broke above its opening range with rising volume. The selected contract passed liquidity checks.",
    ...
    },
    {
      ...
      preferredStructure: closed ? "Contract pending verification" : "NVDA 07/27 $178 Call",
      t1: closed ? null : 3.39,
      stop: closed ? null : 1.81,
      confidence: 76,
      reason: "NVDA reclaimed VWAP and is building momentum, but still needs one confirmation bar.",
    ...
    },
    {
      ...
      stop: null,
      confidence: 71,
      reason: "QQQ is approaching prior-session resistance and needs a confirmed break after the market opens.",
    ...
    },
    {
      ...
      stop: null,
      confidence: 64,
      reason: "META is forming a base below resistance and remains a next-session watch.",
    ...
    },
    {
      ...
      stop: null,
      confidence: 38,
      reason: "The available contract spread is too wide for a reliable entry.",
    ...
    },
    {
      ...
      stop: null,
      confidence: 52,
      reason: "The bearish setup does not yet have an exact contract that passes every live check.",
