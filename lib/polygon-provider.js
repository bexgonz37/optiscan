 ...
 * This is the broad discovery source the curated scan list can't provide — a
 * premarket runner that isn't a pinned name is still visible here. The parser
 * reads `min.av`, so premarket cumulative volume is real, and gain is computed
 * from the previous regular close using the fresh last price. One provider call.
 */
