...
/**
 * SwingResearchPanel — the 1–4 week options research UI, extracted so it can be
 * shown both on the legacy /swing route and inside the consolidated Callouts
 * page (Swing Research tab). Uses its own /api/scan/swing endpoint (distinct
 * from the horizon callouts) — logic is unchanged, only the location moved.
 */
...
export function SwingResearchPanel() {
